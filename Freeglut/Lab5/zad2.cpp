...
void Initialize()
{
    ...
    glAttachShader( program[LIGHT_DISTANCE], LoadShader(GL_VERTEX_SHADER, "shaders/ld_vertex2.glsl"));
    glAttachShader( program[LIGHT_DISTANCE], LoadShader(GL_FRAGMENT_SHADER, "shaders/ld_fragment2.glsl"));
